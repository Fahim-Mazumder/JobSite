    ...
    <body>
            ...
            <div class="container">
                    ...
                    <h3><a href="{{ route('job.index') }}">Home</a></h3>
                        <form class="form-horizontal" method="post" action="{{ route('company.store') }}" enctype="multipart/form-data" align="center" style="margin-top:7%; margin-left:30%">
                            {{ @csrf_field() }}
                        ...
                        <br>
                        <div align="center" style="margin-left:5%">Already registered? Then <a href="{{ route('company.login') }}"><h3>Login here</h3></a></div>
                </div>
                <script>
                    function register() {
